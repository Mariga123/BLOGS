...
def index():
    ...
    return render_template('index.html', quote = quote, job=job, event=event, pitches=pitches, advertisement=advertisement)
...
def new_pitch():
    ...
    if form.validate_on_submit():
        ...
        new_pitch_object = Pitch(post=post, user_id=current_user._get_current_object().id, category=category,
                                 title=title)
